...
private final ButtonGroup buttonGroup_2 = new ButtonGroup();
	...
	public tab() {
		...
		radioButton.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		...
		radioButton_1.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		...
		lblCostumerNo.setFont(new Font("Times New Roman", Font.BOLD, 15));
		panel_3.add(lblCostumerNo);
		
		JLabel lblCarNo = new JLabel("Token No#");
		lblCarNo.setBounds(139, 111, 232, 14);
		lblCarNo.setFont(new Font("Times New Roman", Font.BOLD, 15));
		...
		lblTime.setBounds(139, 173, 232, 14);
		...
		lblEnterInfo.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 20));
		...
		lblEnterCarNo.setFont(new Font("Times New Roman", Font.BOLD, 14));
		panel_5.add(lblEnterCarNo);
		
		JLabel lblDeleteOrder = new JLabel("Delete ID");
		lblDeleteOrder.setBounds(267, 33, 422, 32);
		lblDeleteOrder.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 20));
		...
		lblCarId.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblCarId.setBounds(96, 71, 119, 14);
		panel_9.add(lblCarId);
		
		JLabel lblTokenNo = new JLabel("Token No#");
		lblTokenNo.setFont(new Font("Times New Roman", Font.BOLD, 15));
		...
		lblTime_1.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblTime_1.setBounds(96, 179, 109, 17);
		panel_9.add(lblTime_1);
		
		JLabel lblDay_1 = new JLabel("Day");
		lblDay_1.setFont(new Font("Times New Roman", Font.BOLD, 15));
		...
		label_24.setFont(new Font("Times New Roman", Font.ITALIC, 15));
